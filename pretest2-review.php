...
<script>
    ...
    if(pretest === ''){
        ...
        $('input[name="theme1q1"][value="'+pretest['theme1q1']+'"]').prop('checked', true);
        $('input[name="theme1q2"][value="'+pretest['theme1q2']+'"]').prop('checked', true);
        $('input[name="theme1q3"][value="'+pretest['theme1q3']+'"]').prop('checked', true);
        $('input[name="theme1q4"][value="'+pretest['theme1q4']+'"]').prop('checked', true);
        $('input[name="theme1q5"][value="'+pretest['theme1q5']+'"]').prop('checked', true);
        $('input[name="theme1q6"][value="'+pretest['theme1q6']+'"]').prop('checked', true);
        $('input[name="theme2q1"][value="'+pretest['theme2q1']+'"]').prop('checked', true);
        $('input[name="theme2q2"][value="'+pretest['theme2q2']+'"]').prop('checked', true);
        $('input[name="theme2q3"][value="'+pretest['theme2q3']+'"]').prop('checked', true);
        $('input[name="theme2q4"][value="'+pretest['theme2q4']+'"]').prop('checked', true);
        $('input[name="theme2q5"][value="'+pretest['theme2q5']+'"]').prop('checked', true);
        $('input[name="theme3q1"][value="'+pretest['theme3q1']+'"]').prop('checked', true);
        $('input[name="theme3q2"][value="'+pretest['theme3q2']+'"]').prop('checked', true);
        $('input[name="theme4q1"][value="'+pretest['theme4q1']+'"]').prop('checked', true);
        $('input[name="theme5q1"][value="'+pretest['theme5q1']+'"]').prop('checked', true);
        $('input[name="theme5q2"][value="'+pretest['theme5q2']+'"]').prop('checked', true);
        $('input[name="theme5q3"][value="'+pretest['theme5q3']+'"]').prop('checked', true);
        $('input[name="theme5q4"][value="'+pretest['theme5q4']+'"]').prop('checked', true);
        $('input[name="theme5q5"][value="'+pretest['theme5q5']+'"]').prop('checked', true);
        $('input[name="theme5q6"][value="'+pretest['theme5q6']+'"]').prop('checked', true);
        $('input[name="theme5q7"][value="'+pretest['theme5q7']+'"]').prop('checked', true);
        $('input[name="theme6q1"][value="'+pretest['theme6q1']+'"]').prop('checked', true);
        $('input[name="theme6q2"][value="'+pretest['theme6q2']+'"]').prop('checked', true);
        $('input[name="theme6q3"][value="'+pretest['theme6q3']+'"]').prop('checked', true);
        $('input[name="theme6q4"][value="'+pretest['theme6q4']+'"]').prop('checked', true);
        $('input[name="theme6q5"][value="'+pretest['theme6q5']+'"]').prop('checked', true);    
    }
</script>
</html>